 ...
 */
final class Version20200321155942 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE test_customer (test_id INT NOT NULL, customer_id INT NOT NULL, INDEX IDX_145A855F1E5D0459 (test_id), INDEX IDX_145A855F9395C3F3 (customer_id), PRIMARY KEY(test_id, customer_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
